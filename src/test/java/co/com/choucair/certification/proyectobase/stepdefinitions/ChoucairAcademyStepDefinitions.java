...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanArmandoWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) {

        OnStage.theActorCalled("Armando").wasAbleTo(OpenUp.thePage(), (Login.
    ...
    public void heSearchForTheCoursesOnTheChoucairAcademyPlatform(List<AcademyChoucairData> academyChoucairData) {
